...
allowed-tools:
  ...
  - Bash
  - Agent
  - mcp__jyry__start_milestone_audit
  - mcp__jyry__submit_milestone_audit
  - mcp__jyry__get_milestone_audit_context
  - mcp__jyry__get_milestone_overview
  - mcp__jyry__log_action
  - mcp__jyry__toggle_checklist_item
---
...
Call `mcp__jyry__start_milestone_audit(milestone_id)`. This:
...
Call `mcp__jyry__submit_milestone_audit(milestone_id, verdict, findings, checklist_updates, report_path, state_doc_path)`. The MCP server:
