# JYRY Command Center Historical Spec — JYRY Compatibility Build Spec v1.0

> Historical note: this document describes the original JYRY-first build shape. The public platform identity is now JYRY Command Center (`jyry-command-center`), and JYRY is a compatibility profile.

**What this is:** The complete build specification for an Electron desktop app that serves as the project management command center for the JYRY product. This document is the prompt. An agent reading this file should be able to build the app from scratch.

**Project location:** `/Users/luqman/Desktop/Projects/jyry-command-center/`

**Source data files (read-only references — do NOT modify):**
- `/Users/luqman/Desktop/Projects/jyry/docs/roadmap.md` — The 20-week build roadmap. Every milestone, sub-task, and deliverable in the command center is extracted from this file.
- `/Users/luqman/Desktop/Projects/jyry/docs/manifesto.md` — Product architecture reference. The 3 Domains (Storefront, Product Ops, Commerce Intelligence) and the submission checklist categories come from here.
- `/Users/luqman/Desktop/Projects/jyry/docs/submission-checklist.md` — The full 12-category, 58-item pre-submission checklist.

**Design system:**
- Dark theme (background: `#0A0A10`, surface: `#111118`, border: `#1a1a2e`)
- JYRY Indigo palette: Accent `#585CF0`, Accent Light `#8286FF`, Muted `#9B9BAA`, White `#FFFFFF`
...
**Path:** `/Users/luqman/Desktop/Projects/jyry/jyry-tracker.json`
...
- All three views reflect the same underlying `jyry-tracker.json` state

---

## Shared State File Schema

The `jyry-tracker.json` file must conform to this schema. **Phase 1 must generate this file by parsing the roadmap markdown.**
...
- Configure Tailwind with the JYRY design system colors as custom theme values
...
**This is the most critical piece of Phase 1.** Build a parser that reads the three source markdown files and generates the initial `jyry-tracker.json`.

Parser requirements:
- Read `/Users/luqman/Desktop/Projects/jyry/docs/roadmap.md` and extract:
...
- Read `/Users/luqman/Desktop/Projects/jyry/docs/submission-checklist.md` and extract:
...
- Generate `jyry-tracker.json` with the full schema above
- Write the file to `/Users/luqman/Desktop/Projects/jyry/jyry-tracker.json`
...
- State is loaded from `jyry-tracker.json` into Zustand store on app launch
- File watcher initialized on launch, updates Zustand store when external changes detected

### 1.4 — State Management Layer

- Zustand store initialized from `jyry-tracker.json`
...
6. **Respect the design system.** Dark theme, JYRY colors, Inter font. The app should feel like it belongs alongside the JYRY product itself.
...
*This document is the original build spec for the JYRY compatibility version of JYRY Command Center. The source data lives in the roadmap and manifesto markdown files. The output is an Electron app that every agent on the project can read, write, and orient from.*
