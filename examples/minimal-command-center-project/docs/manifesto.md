# Minimal Command Center Project Manifesto

This project exists to demonstrate the public `generic` profile path first.

## Principles

- Bootstrap explicitly from a project root.
...
- Real dashboard consumption of the generated tracker
