...
1. Call `mcp__jyry__start_milestone_audit(milestone_id)` — validates all subtasks are `done`, returns context bundle.
...
5. Call `mcp__jyry__submit_milestone_audit(...)` to persist + auto-tick verifiable submission-checklist items.
